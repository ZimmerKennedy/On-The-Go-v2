...
import { setDepartingFlightData } from "../flightSearch/setRoundtripFlightUser";
import { useNavigate } from "react-router-dom";
const DepartingFlightOneWay = () => {
  ...
  const handleFlightSelection = (data) => {
    ...
    navigate('/flight-details-one-way')
  };
...
export default DepartingFlightOneWay;
