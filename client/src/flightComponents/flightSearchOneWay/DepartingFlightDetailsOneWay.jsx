...
const DepartingFlightDetailsOneWay = () => {
  const flightData = useSelector((state) => state.userFlights);
  
  
  const departure = flightData.data.getAirFlightRoundTrip.results.result.search_data.search_0
  console.log(`flightData from UserInfo`, departure);
...
export default DepartingFlightDetailsOneWay;
